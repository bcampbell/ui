...
// 	free(m);
// }
// static uiFontDescriptor *newFontDescriptor(void)
// {
// 	uiFontDescriptor *desc;
//
// 	desc = (uiFontDescriptor *) malloc(sizeof (uiFontDescriptor));
// 	// TODO
// 	return desc;
// }
...
// TODO: uiAttributedString and related stuff
...
/*
TODO: implement new NewTextLayout (using uiDrawTextLayoutParams)
...
func (c *DrawContext) Text(layout *TextLayout, x float64, y float64) {
	C.uiDrawText(c.c, layout.l, C.double(x), C.double(y))
}
